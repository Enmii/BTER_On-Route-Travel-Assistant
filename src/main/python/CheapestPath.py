def aStarAlgo(start_node, stop_node):
    ...
    while len(open_set) > 0:
        ...
        if n == stop_node:
            ...
            ##Fare cost code
            fare = 13
            if start_node == 'E' or start_node == 'F' or start_node == 'G':
                if stop_node == 'E' or stop_node == 'F' or stop_node == 'G':
                    fare = 30

            elif 'E' in path or 'F' in path or 'G' in path:
                fare += 30
                if distance_total <= 5:
                    print(fare)
                else:
